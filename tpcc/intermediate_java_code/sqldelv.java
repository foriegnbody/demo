...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM SQLDELV ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            trace_sqldelv_OF_tpc_trace_module_id_OF_tpc_trace_data_block=new Level88("trace-sqldelv",tpc_trace_module_id_OF_tpc_trace_data_block, new byte[]{-47}, null, null, null, new Object[]{new byte[]{-47}});
            ...
            trace_sql_delete_OF_tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-sql-delete",tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block, "D ", null, null, null, new Object[]{"D "});
            trace_sql_csr_declare_OF_tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-sql-csr-declare",tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block, "CD", null, null, null, new Object[]{"CD"});
            trace_sql_csr_open_OF_tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-sql-csr-open",tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block, "CO", null, null, null, new Object[]{"CO"});
            trace_sql_csr_fetch_OF_tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-sql-csr-fetch",tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block, "CF", null, null, null, new Object[]{"CF"});
            trace_sql_csr_close_OF_tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-sql-csr-close",tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block, "CC", null, null, null, new Object[]{"CC"});
        ...
        public void declarations()
        {
            ...
            w_id.declare(_memory,344,4,"w-id",9,null,null,null,o_carrier_id,0x04400000);
            o_carrier_id.declare(_memory,841,4,"o-carrier-id",9,null,null,null,ol_total,0x04400000);
            ol_total.declare(_memory,909,7,"ol-total",12,null,null,null,d_id,0x04400000,2,0);
            d_id.declare(_memory,916,4,"d-id",9,null,null,null,c_id,0x04400000);
            c_id.declare(_memory,1019,4,"c-id",9,null,null,null,no_o_id,0x04400000);
            no_o_id.declare(_memory,2234,4,"no-o-id",9,null,null,null,d_log,0x04400000);
            d_log.declare(_memory,2246,80,"d-log",null,null,null,null,csqlcode,0x00000000);
            ...
            filler_0_.declare(_memory,2350,20,"datetime",null,null,null,dtyear_OF_filler_0_,tpcc_log_rec,0x00100000,1,1,datetime);
            tpcc_log_rec.declare(_memory,2370,80,"tpcc-log-rec",null,null,null,null,dist_per_ware,0x00000000);
            dist_per_ware.declare(_memory,2458,2,"dist-per-ware",2,"10",null,null,did,0x04000000);
            ...
            tpc_trace_module_id_OF_tpc_trace_data_block.declare(_memory,2483,1,"tpc-trace-module-id",null,null,tpc_trace_data_block,null,tpc_trace_call_seq_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_seq_OF_tpc_trace_data_block.declare(_memory,2484,1,"tpc-trace-call-seq",null,null,tpc_trace_data_block,null,tpc_trace_call_type_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_type_OF_tpc_trace_data_block.declare(_memory,2485,1,"tpc-trace-call-type",null,null,tpc_trace_data_block,null,tpc_trace_data_length_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_data_length_OF_tpc_trace_data_block.declare(_memory,2486,2,"tpc-trace-data-length",4,null,tpc_trace_data_block,null,tpc_trace_data_OF_tpc_trace_data_block,0x04000000);
            tpc_trace_data_OF_tpc_trace_data_block.declare(_memory,2488,128,"tpc-trace-data",null,null,tpc_trace_data_block,null,filler_7__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block.declare(_memory,2488,2,"tpc-trace-sql-function",null,null,filler_7__OF_tpc_trace_data_block,null,tpc_trace_info_OF_filler_7__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_info_OF_filler_7__OF_tpc_trace_data_block.declare(_memory,2492,124,"tpc-trace-info",null,null,filler_7__OF_tpc_trace_data_block,null,null,0x00000000);
            filler_7__OF_tpc_trace_data_block.declare(_memory,2488,128,"tpc-trace-data",null,null,tpc_trace_data_block,tpc_trace_sql_function_OF_filler_7__OF_tpc_trace_data_block,null,0x00100000,1,1,tpc_trace_data_OF_tpc_trace_data_block);
            tpc_trace_data_block.declare(_memory,2483,133,"tpc-trace-data-block",null,null,null,tpc_trace_module_id_OF_tpc_trace_data_block,null,0x00000000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void declarations()
        {
            ...
            result_code_OF_common_data_OF_delivery_data_OF_dfhcommarea.declare(_memory,166,4,"result-code",9,null,common_data_OF_delivery_data_OF_dfhcommarea,null,tpc_trace_flag_OF_common_data_OF_delivery_data_OF_dfhcommarea,0x04400000);
            tpc_trace_flag_OF_common_data_OF_delivery_data_OF_dfhcommarea.declare(_memory,170,1,"tpc-trace-flag",null,null,common_data_OF_delivery_data_OF_dfhcommarea,null,null,0x00000000);
    ...
    public final int main_OF_defaultsection_0()
    {
        ...
        lnk.msg_OF_common_data_OF_delivery_data_OF_dfhcommarea.move("Delivery processing complete");
        try
        {
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 4: case 5: if( (_begin=fileerror_para_OF_fileerror()) != 0) break;
                    if(_end==_fileerror_para_OF_fileerror_Label) return  ;
