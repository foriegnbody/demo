...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM SQLPAYM ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            trace_sqlpaym_OF_tpc_trace_module_id_OF_tpc_trace_data_block=new Level88("trace-sqlpaym",tpc_trace_module_id_OF_tpc_trace_data_block, new byte[]{-43}, null, null, null, new Object[]{new byte[]{-43}});
            ...
            trace_sql_select_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-select",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "S ", null, null, null, new Object[]{"S "});
            trace_sql_insert_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-insert",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "I ", null, null, null, new Object[]{"I "});
            trace_sql_update_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-update",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "U ", null, null, null, new Object[]{"U "});
            trace_sql_csr_declare_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-csr-declare",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "CD", null, null, null, new Object[]{"CD"});
            trace_sql_csr_open_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-csr-open",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "CO", null, null, null, new Object[]{"CO"});
            trace_sql_csr_fetch_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-csr-fetch",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "CF", null, null, null, new Object[]{"CF"});
            trace_sql_csr_close_OF_tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-sql-csr-close",tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block, "CC", null, null, null, new Object[]{"CC"});
        ...
        public void declarations()
        {
            ...
            w_id.declare(_memory,344,4,"w-id",9,null,null,null,w_name,0x04400000);
            w_name.declare(_memory,348,10,"w-name",null,null,null,null,w_street_1,0x00000000);
            w_street_1.declare(_memory,358,20,"w-street-1",null,null,null,null,w_street_2,0x00000000);
            w_street_2.declare(_memory,378,20,"w-street-2",null,null,null,null,w_city,0x00000000);
            w_city.declare(_memory,398,20,"w-city",null,null,null,null,w_state,0x00000000);
            w_state.declare(_memory,418,2,"w-state",null,null,null,null,w_zip,0x00000000);
            w_zip.declare(_memory,420,9,"w-zip",null,null,null,null,d_id,0x00000000);
            d_id.declare(_memory,916,4,"d-id",9,null,null,null,d_name,0x04400000);
            d_name.declare(_memory,924,10,"d-name",null,null,null,null,d_street_1,0x00000000);
            d_street_1.declare(_memory,934,20,"d-street-1",null,null,null,null,d_street_2,0x00000000);
            d_street_2.declare(_memory,954,20,"d-street-2",null,null,null,null,d_city,0x00000000);
            d_city.declare(_memory,974,20,"d-city",null,null,null,null,d_state,0x00000000);
            d_state.declare(_memory,994,2,"d-state",null,null,null,null,d_zip,0x00000000);
            d_zip.declare(_memory,996,9,"d-zip",null,null,null,null,c_id,0x00000000);
            c_id.declare(_memory,1019,4,"c-id",9,null,null,null,c_d_id,0x04400000);
            c_d_id.declare(_memory,1023,4,"c-d-id",9,null,null,null,c_w_id,0x04400000);
            c_w_id.declare(_memory,1027,4,"c-w-id",9,null,null,null,c_first,0x04400000);
            c_first.declare(_memory,1031,16,"c-first",null,null,null,null,c_middle,0x00000000);
            c_middle.declare(_memory,1047,2,"c-middle",null,null,null,null,c_last,0x00000000);
            c_last.declare(_memory,1049,16,"c-last",null,null,null,null,c_street_1,0x00000000);
            c_street_1.declare(_memory,1065,20,"c-street-1",null,null,null,null,c_street_2,0x00000000);
            c_street_2.declare(_memory,1085,20,"c-street-2",null,null,null,null,c_city,0x00000000);
            c_city.declare(_memory,1105,20,"c-city",null,null,null,null,c_state,0x00000000);
            c_state.declare(_memory,1125,2,"c-state",null,null,null,null,c_zip,0x00000000);
            c_zip.declare(_memory,1127,9,"c-zip",null,null,null,null,c_phone,0x00000000);
            c_phone.declare(_memory,1136,16,"c-phone",null,null,null,null,c_since,0x00000000);
            c_since.declare(_memory,1152,20,"c-since",null,null,null,null,c_credit,0x00000000);
            c_credit.declare(_memory,1172,2,"c-credit",null,null,null,null,c_credit_lim,0x00000000);
            c_credit_lim.declare(_memory,1174,7,"c-credit-lim",12,null,null,null,c_discount,0x04400000,2,0);
            c_discount.declare(_memory,1181,3,"c-discount",4,null,null,null,c_balance,0x04400000,4,0);
            c_balance.declare(_memory,1184,7,"c-balance",12,null,null,null,c_data,0x04400000,2,0);
            c_data_len_OF_c_data.declare(_memory,1202,2,"c-data-len",4,null,c_data,null,c_data_data_OF_c_data,0x04400000);
            c_data_data_OF_c_data.declare(_memory,1204,500,"c-data-data",null,null,c_data,null,null,0x00000000);
            c_data.declare(_memory,1202,502,"c-data",null,null,null,c_data_len_OF_c_data,c_new_data,0x00002000);
            c_new_data_len_OF_c_new_data.declare(_memory,1704,2,"c-new-data-len",4,null,c_new_data,null,c_new_data_data_OF_c_new_data,0x04400000);
            c_new_data_data_OF_c_new_data.declare(_memory,1706,500,"c-new-data-data",null,null,c_new_data,null,null,0x00000000);
            c_new_data.declare(_memory,1704,502,"c-new-data",null,null,null,c_new_data_len_OF_c_new_data,h_amount,0x00002000);
            h_amount.declare(_memory,2206,4,"h-amount",6,null,null,null,h_data,0x04400000,2,0);
            h_data.declare(_memory,2210,24,"h-data",null,null,null,null,csqlcode,0x00000000);
            ...
            filler_0_.declare(_memory,2350,19,"datetime",null,null,null,dtyear_OF_filler_0_,n,0x00100000,1,1,datetime);
            ...
            tpc_trace_module_id_OF_tpc_trace_data_block.declare(_memory,2381,1,"tpc-trace-module-id",null,null,tpc_trace_data_block,null,tpc_trace_call_seq_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_seq_OF_tpc_trace_data_block.declare(_memory,2382,1,"tpc-trace-call-seq",null,null,tpc_trace_data_block,null,tpc_trace_call_type_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_type_OF_tpc_trace_data_block.declare(_memory,2383,1,"tpc-trace-call-type",null,null,tpc_trace_data_block,null,tpc_trace_data_length_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_data_length_OF_tpc_trace_data_block.declare(_memory,2384,2,"tpc-trace-data-length",4,null,tpc_trace_data_block,null,tpc_trace_data_OF_tpc_trace_data_block,0x04000000);
            tpc_trace_data_OF_tpc_trace_data_block.declare(_memory,2386,128,"tpc-trace-data",null,null,tpc_trace_data_block,null,filler_6__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block.declare(_memory,2386,2,"tpc-trace-sql-function",null,null,filler_6__OF_tpc_trace_data_block,null,tpc_trace_info_OF_filler_6__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_info_OF_filler_6__OF_tpc_trace_data_block.declare(_memory,2390,124,"tpc-trace-info",null,null,filler_6__OF_tpc_trace_data_block,null,null,0x00000000);
            filler_6__OF_tpc_trace_data_block.declare(_memory,2386,128,"tpc-trace-data",null,null,tpc_trace_data_block,tpc_trace_sql_function_OF_filler_6__OF_tpc_trace_data_block,null,0x00100000,1,1,tpc_trace_data_OF_tpc_trace_data_block);
            tpc_trace_data_block.declare(_memory,2381,133,"tpc-trace-data-block",null,null,null,tpc_trace_module_id_OF_tpc_trace_data_block,null,0x00000000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void declarations()
        {
            ...
            tpc_trace_flag_OF_common_data_OF_payment_data_OF_dfhcommarea.declare(_memory,716,1,"tpc-trace-flag",null,null,common_data_OF_payment_data_OF_dfhcommarea,null,null,0x00000000);
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 2: case 1: if( (_begin=main_OF_defaultsection_0()) != 0) break;
                    if(_end==_main_OF_defaultsection_0_Label) return  ;
                    
                    case 5: if( (_begin=cust_not_found_OF_defaultsection_0()) != 0) break;
                    if(_end==_cust_not_found_OF_defaultsection_0_Label) return  ;
                    
                    case 3: if( (_begin=sqlerr_OF_defaultsection_0()) != 0) break;
                    if(_end==_sqlerr_OF_defaultsection_0_Label) return  ;
