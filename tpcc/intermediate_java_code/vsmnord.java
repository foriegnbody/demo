...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM VSMNORD ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            trace_vsmnord_OF_tpc_trace_module_id_OF_tpc_trace_data_block=new Level88("trace-vsmnord",tpc_trace_module_id_OF_tpc_trace_data_block, new byte[]{-37}, null, null, null, new Object[]{new byte[]{-37}});
            tpc_trace_call_seq_OF_tpc_trace_data_block=new Variable();
            tpc_trace_call_type_OF_tpc_trace_data_block=new Variable();
            trace_before_call_OF_tpc_trace_call_type_OF_tpc_trace_data_block=new Level88("trace-before-call",tpc_trace_call_type_OF_tpc_trace_data_block, new byte[]{3}, null, null, null, new Object[]{new byte[]{3}});
            trace_after_call_OF_tpc_trace_call_type_OF_tpc_trace_data_block=new Level88("trace-after-call",tpc_trace_call_type_OF_tpc_trace_data_block, new byte[]{4}, null, null, null, new Object[]{new byte[]{4}});
            ...
            trace_vsm_read_OF_tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-vsm-read",tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block, "R ", null, null, null, new Object[]{"R "});
            trace_vsm_read_update_OF_tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-vsm-read-update",tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block, "RU", null, null, null, new Object[]{"RU"});
            trace_vsm_write_OF_tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-vsm-write",tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block, "W ", null, null, null, new Object[]{"W "});
            trace_vsm_rewrite_OF_tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block=new Level88("trace-vsm-rewrite",tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block, "RW", null, null, null, new Object[]{"RW"});
        ...
        public void declarations()
        {
            ...
            w_id_OF_warehouse_key_OF_w_record.declare(_memory,8,9,"w-id",9,null,warehouse_key_OF_w_record,null,null,0x04400000);
            warehouse_key_OF_w_record.declare(_memory,8,9,"warehouse-key",null,null,w_record,w_id_OF_warehouse_key_OF_w_record,w_name_OF_w_record,0x00000000);
            w_name_OF_w_record.declare(_memory,17,10,"w-name",null,null,w_record,null,w_street_1_OF_w_record,0x00000000);
            w_street_1_OF_w_record.declare(_memory,27,20,"w-street-1",null,null,w_record,null,w_street_2_OF_w_record,0x00000000);
            w_street_2_OF_w_record.declare(_memory,47,20,"w-street-2",null,null,w_record,null,w_city_OF_w_record,0x00000000);
            w_city_OF_w_record.declare(_memory,67,20,"w-city",null,null,w_record,null,w_state_OF_w_record,0x00000000);
            w_state_OF_w_record.declare(_memory,87,2,"w-state",null,null,w_record,null,w_zip_OF_w_record,0x00000000);
            w_zip_OF_w_record.declare(_memory,89,9,"w-zip",null,null,w_record,null,w_tax_OF_w_record,0x00000000);
            w_tax_OF_w_record.declare(_memory,98,4,"w-tax",4,null,w_record,null,w_ytd_OF_w_record,0x04400000,4,0);
            w_ytd_OF_w_record.declare(_memory,102,12,"w-ytd",12,null,w_record,null,null,0x04400000,2,0);
            w_record.declare(_memory,8,106,"w-record",null,null,null,warehouse_key_OF_w_record,d_record,0x00000000);
            d_w_id_OF_district_key_OF_d_record.declare(_memory,114,9,"d-w-id",9,null,district_key_OF_d_record,null,d_id_OF_district_key_OF_d_record,0x04400000);
            d_id_OF_district_key_OF_d_record.declare(_memory,123,9,"d-id",9,null,district_key_OF_d_record,null,null,0x04400000);
            district_key_OF_d_record.declare(_memory,114,18,"district-key",null,null,d_record,d_w_id_OF_district_key_OF_d_record,d_name_OF_d_record,0x00000000);
            d_name_OF_d_record.declare(_memory,132,10,"d-name",null,null,d_record,null,d_street_1_OF_d_record,0x00000000);
            d_street_1_OF_d_record.declare(_memory,142,20,"d-street-1",null,null,d_record,null,d_street_2_OF_d_record,0x00000000);
            d_street_2_OF_d_record.declare(_memory,162,20,"d-street-2",null,null,d_record,null,d_city_OF_d_record,0x00000000);
            d_city_OF_d_record.declare(_memory,182,20,"d-city",null,null,d_record,null,d_state_OF_d_record,0x00000000);
            d_state_OF_d_record.declare(_memory,202,2,"d-state",null,null,d_record,null,d_zip_OF_d_record,0x00000000);
            d_zip_OF_d_record.declare(_memory,204,9,"d-zip",null,null,d_record,null,d_tax_OF_d_record,0x00000000);
            d_tax_OF_d_record.declare(_memory,213,4,"d-tax",4,null,d_record,null,d_ytd_OF_d_record,0x04400000,4,0);
            d_ytd_OF_d_record.declare(_memory,217,12,"d-ytd",12,null,d_record,null,d_next_o_id_OF_d_record,0x04400000,2,0);
            d_next_o_id_OF_d_record.declare(_memory,229,9,"d-next-o-id",9,null,d_record,null,null,0x04400000);
            d_record.declare(_memory,114,124,"d-record",null,null,null,district_key_OF_d_record,c_record,0x00000000);
            c_w_id_OF_customer_key_OF_c_record.declare(_memory,238,9,"c-w-id",9,null,customer_key_OF_c_record,null,c_d_id_OF_customer_key_OF_c_record,0x04400000);
            c_d_id_OF_customer_key_OF_c_record.declare(_memory,247,9,"c-d-id",9,null,customer_key_OF_c_record,null,c_id_OF_customer_key_OF_c_record,0x04400000);
            c_id_OF_customer_key_OF_c_record.declare(_memory,256,9,"c-id",9,null,customer_key_OF_c_record,null,null,0x04400000);
            customer_key_OF_c_record.declare(_memory,238,27,"customer-key",null,null,c_record,c_w_id_OF_customer_key_OF_c_record,customer_alt_key_OF_c_record,0x00000000);
            c_w_id2_OF_customer_generic_name_OF_customer_alt_key_OF_c_record.declare(_memory,265,9,"c-w-id2",9,null,customer_generic_name_OF_customer_alt_key_OF_c_record,null,c_d_id2_OF_customer_generic_name_OF_customer_alt_key_OF_c_record,0x04400000);
            c_d_id2_OF_customer_generic_name_OF_customer_alt_key_OF_c_record.declare(_memory,274,9,"c-d-id2",9,null,customer_generic_name_OF_customer_alt_key_OF_c_record,null,c_last_OF_customer_generic_name_OF_customer_alt_key_OF_c_record,0x04400000);
            c_last_OF_customer_generic_name_OF_customer_alt_key_OF_c_record.declare(_memory,283,16,"c-last",null,null,customer_generic_name_OF_customer_alt_key_OF_c_record,null,null,0x00000000);
            customer_generic_name_OF_customer_alt_key_OF_c_record.declare(_memory,265,34,"customer-generic-name",null,null,customer_alt_key_OF_c_record,c_w_id2_OF_customer_generic_name_OF_customer_alt_key_OF_c_record,c_first_OF_customer_alt_key_OF_c_record,0x00000000);
            c_first_OF_customer_alt_key_OF_c_record.declare(_memory,299,16,"c-first",null,null,customer_alt_key_OF_c_record,null,null,0x00000000);
            customer_alt_key_OF_c_record.declare(_memory,265,50,"customer-alt-key",null,null,c_record,customer_generic_name_OF_customer_alt_key_OF_c_record,c_middle_OF_c_record,0x00000000);
            c_middle_OF_c_record.declare(_memory,315,2,"c-middle",null,null,c_record,null,c_street_1_OF_c_record,0x00000000);
            c_street_1_OF_c_record.declare(_memory,317,20,"c-street-1",null,null,c_record,null,c_street_2_OF_c_record,0x00000000);
            c_street_2_OF_c_record.declare(_memory,337,20,"c-street-2",null,null,c_record,null,c_city_OF_c_record,0x00000000);
            c_city_OF_c_record.declare(_memory,357,20,"c-city",null,null,c_record,null,c_state_OF_c_record,0x00000000);
            c_state_OF_c_record.declare(_memory,377,2,"c-state",null,null,c_record,null,c_zip_OF_c_record,0x00000000);
            c_zip_OF_c_record.declare(_memory,379,9,"c-zip",null,null,c_record,null,c_phone_OF_c_record,0x00000000);
            c_phone_OF_c_record.declare(_memory,388,16,"c-phone",null,null,c_record,null,c_since_OF_c_record,0x00000000);
            c_since_OF_c_record.declare(_memory,404,20,"c-since",null,null,c_record,null,c_credit_OF_c_record,0x00000000);
            c_credit_OF_c_record.declare(_memory,424,2,"c-credit",null,null,c_record,null,c_credit_lim_OF_c_record,0x00000000);
            c_credit_lim_OF_c_record.declare(_memory,426,12,"c-credit-lim",12,null,c_record,null,c_discount_OF_c_record,0x04400000,2,0);
            c_discount_OF_c_record.declare(_memory,438,4,"c-discount",4,null,c_record,null,c_balance_OF_c_record,0x04400000,4,0);
            c_balance_OF_c_record.declare(_memory,442,12,"c-balance",12,null,c_record,null,c_ytd_payment_OF_c_record,0x04400000,2,0);
            c_ytd_payment_OF_c_record.declare(_memory,454,12,"c-ytd-payment",12,null,c_record,null,c_payment_cnt_OF_c_record,0x04400000,2,0);
            c_payment_cnt_OF_c_record.declare(_memory,466,4,"c-payment-cnt",4,null,c_record,null,c_delivery_cnt_OF_c_record,0x04000000);
            c_delivery_cnt_OF_c_record.declare(_memory,470,4,"c-delivery-cnt",4,null,c_record,null,c_data_OF_c_record,0x04000000);
            c_data_OF_c_record.declare(_memory,474,500,"c-data",null,null,c_record,null,null,0x00000000);
            c_record.declare(_memory,238,736,"c-record",null,null,null,customer_key_OF_c_record,no_record,0x00000000);
            no_w_id_OF_new_order_key_OF_no_record.declare(_memory,1069,9,"no-w-id",9,null,new_order_key_OF_no_record,null,no_d_id_OF_new_order_key_OF_no_record,0x04400000);
            no_d_id_OF_new_order_key_OF_no_record.declare(_memory,1078,9,"no-d-id",9,null,new_order_key_OF_no_record,null,no_o_id_OF_new_order_key_OF_no_record,0x04400000);
            no_o_id_OF_new_order_key_OF_no_record.declare(_memory,1087,9,"no-o-id",9,null,new_order_key_OF_no_record,null,null,0x04400000);
            new_order_key_OF_no_record.declare(_memory,1069,27,"new-order-key",null,null,no_record,no_w_id_OF_new_order_key_OF_no_record,null,0x00000000);
            no_record.declare(_memory,1069,27,"no-record",null,null,null,new_order_key_OF_no_record,o_record,0x00000000);
            o_w_id_OF_order_key_OF_o_record.declare(_memory,1096,9,"o-w-id",9,null,order_key_OF_o_record,null,o_d_id_OF_order_key_OF_o_record,0x04400000);
            o_d_id_OF_order_key_OF_o_record.declare(_memory,1105,9,"o-d-id",9,null,order_key_OF_o_record,null,o_id_OF_order_key_OF_o_record,0x04400000);
            o_id_OF_order_key_OF_o_record.declare(_memory,1114,9,"o-id",9,null,order_key_OF_o_record,null,null,0x04400000);
            order_key_OF_o_record.declare(_memory,1096,27,"order-key",null,null,o_record,o_w_id_OF_order_key_OF_o_record,order_alt_key_OF_o_record,0x00000000);
            o_w_id2_OF_order_alt_key_OF_o_record.declare(_memory,1123,9,"o-w-id2",9,null,order_alt_key_OF_o_record,null,o_d_id2_OF_order_alt_key_OF_o_record,0x04400000);
            o_d_id2_OF_order_alt_key_OF_o_record.declare(_memory,1132,9,"o-d-id2",9,null,order_alt_key_OF_o_record,null,o_c_id_OF_order_alt_key_OF_o_record,0x04400000);
            o_c_id_OF_order_alt_key_OF_o_record.declare(_memory,1141,9,"o-c-id",9,null,order_alt_key_OF_o_record,null,null,0x04400000);
            order_alt_key_OF_o_record.declare(_memory,1123,27,"order-alt-key",null,null,o_record,o_w_id2_OF_order_alt_key_OF_o_record,o_entry_d_OF_o_record,0x00000000);
            o_entry_d_OF_o_record.declare(_memory,1150,20,"o-entry-d",null,null,o_record,null,o_carrier_id_OF_o_record,0x00000000);
            o_carrier_id_OF_o_record.declare(_memory,1170,9,"o-carrier-id",9,null,o_record,null,o_ol_cnt_OF_o_record,0x04400000);
            o_ol_cnt_OF_o_record.declare(_memory,1179,9,"o-ol-cnt",9,null,o_record,null,o_all_local_OF_o_record,0x04400000);
            o_all_local_OF_o_record.declare(_memory,1188,9,"o-all-local",9,null,o_record,null,null,0x04400000);
            o_record.declare(_memory,1096,101,"o-record",null,null,null,order_key_OF_o_record,ol_record,0x00000000);
            ol_w_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record.declare(_memory,1197,9,"ol-w-id",9,null,order_line_alt_key_OF_order_line_key_OF_ol_record,null,ol_d_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record,0x04400000);
            ol_d_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record.declare(_memory,1206,9,"ol-d-id",9,null,order_line_alt_key_OF_order_line_key_OF_ol_record,null,ol_o_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record,0x04400000);
            ol_o_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record.declare(_memory,1215,9,"ol-o-id",9,null,order_line_alt_key_OF_order_line_key_OF_ol_record,null,null,0x04400000);
            order_line_alt_key_OF_order_line_key_OF_ol_record.declare(_memory,1197,27,"order-line-alt-key",null,null,order_line_key_OF_ol_record,ol_w_id_OF_order_line_alt_key_OF_order_line_key_OF_ol_record,ol_number_OF_order_line_key_OF_ol_record,0x00000000);
            ol_number_OF_order_line_key_OF_ol_record.declare(_memory,1224,9,"ol-number",9,null,order_line_key_OF_ol_record,null,null,0x04400000);
            order_line_key_OF_ol_record.declare(_memory,1197,36,"order-line-key",null,null,ol_record,order_line_alt_key_OF_order_line_key_OF_ol_record,ol_i_id_OF_ol_record,0x00000000);
            ol_i_id_OF_ol_record.declare(_memory,1233,9,"ol-i-id",9,null,ol_record,null,ol_supply_w_id_OF_ol_record,0x04400000);
            ol_supply_w_id_OF_ol_record.declare(_memory,1242,9,"ol-supply-w-id",9,null,ol_record,null,ol_delivery_d_OF_ol_record,0x04400000);
            ol_delivery_d_OF_ol_record.declare(_memory,1251,20,"ol-delivery-d",null,null,ol_record,null,ol_quantity_OF_ol_record,0x00000000);
            ol_quantity_OF_ol_record.declare(_memory,1271,9,"ol-quantity",9,null,ol_record,null,ol_amount_OF_ol_record,0x04400000);
            ol_amount_OF_ol_record.declare(_memory,1280,9,"ol-amount",9,null,ol_record,null,ol_dist_info_OF_ol_record,0x04400000);
            ol_dist_info_OF_ol_record.declare(_memory,1289,24,"ol-dist-info",null,null,ol_record,null,null,0x00000000);
            ol_record.declare(_memory,1197,116,"ol-record",null,null,null,order_line_key_OF_ol_record,i_record,0x00000000);
            i_id_OF_item_key_OF_i_record.declare(_memory,1313,9,"i-id",9,null,item_key_OF_i_record,null,null,0x04400000);
            item_key_OF_i_record.declare(_memory,1313,9,"item-key",null,null,i_record,i_id_OF_item_key_OF_i_record,i_im_id_OF_i_record,0x00000000);
            i_im_id_OF_i_record.declare(_memory,1322,9,"i-im-id",9,null,i_record,null,i_name_OF_i_record,0x04400000);
            i_name_OF_i_record.declare(_memory,1331,24,"i-name",null,null,i_record,null,i_price_OF_i_record,0x00000000);
            i_price_OF_i_record.declare(_memory,1355,5,"i-price",5,null,i_record,null,i_data_OF_i_record,0x04400000,2,0);
            i_data_OF_i_record.declare(_memory,1360,50,"i-data",null,null,i_record,null,null,0x00000000);
            i_record.declare(_memory,1313,97,"i-record",null,null,null,item_key_OF_i_record,s_record,0x00000000);
            s_w_id_OF_stock_key_OF_s_record.declare(_memory,1410,9,"s-w-id",9,null,stock_key_OF_s_record,null,s_i_id_OF_stock_key_OF_s_record,0x04400000);
            s_i_id_OF_stock_key_OF_s_record.declare(_memory,1419,9,"s-i-id",9,null,stock_key_OF_s_record,null,null,0x04400000);
            stock_key_OF_s_record.declare(_memory,1410,18,"stock-key",null,null,s_record,s_w_id_OF_stock_key_OF_s_record,s_quantity_OF_s_record,0x00000000);
            s_quantity_OF_s_record.declare(_memory,1428,4,"s-quantity",4,null,s_record,null,s_dist_01_OF_s_record,0x04400000);
            s_dist_01_OF_s_record.declare(_memory,1432,24,"s-dist-01",null,null,s_record,null,s_dist_02_OF_s_record,0x00000000);
            s_dist_02_OF_s_record.declare(_memory,1456,24,"s-dist-02",null,null,s_record,null,s_dist_03_OF_s_record,0x00000000);
            s_dist_03_OF_s_record.declare(_memory,1480,24,"s-dist-03",null,null,s_record,null,s_dist_04_OF_s_record,0x00000000);
            s_dist_04_OF_s_record.declare(_memory,1504,24,"s-dist-04",null,null,s_record,null,s_dist_05_OF_s_record,0x00000000);
            s_dist_05_OF_s_record.declare(_memory,1528,24,"s-dist-05",null,null,s_record,null,s_dist_06_OF_s_record,0x00000000);
            s_dist_06_OF_s_record.declare(_memory,1552,24,"s-dist-06",null,null,s_record,null,s_dist_07_OF_s_record,0x00000000);
            s_dist_07_OF_s_record.declare(_memory,1576,24,"s-dist-07",null,null,s_record,null,s_dist_08_OF_s_record,0x00000000);
            s_dist_08_OF_s_record.declare(_memory,1600,24,"s-dist-08",null,null,s_record,null,s_dist_09_OF_s_record,0x00000000);
            s_dist_09_OF_s_record.declare(_memory,1624,24,"s-dist-09",null,null,s_record,null,s_dist_10_OF_s_record,0x00000000);
            s_dist_10_OF_s_record.declare(_memory,1648,24,"s-dist-10",null,null,s_record,null,s_ytd_OF_s_record,0x00000000);
            s_ytd_OF_s_record.declare(_memory,1672,8,"s-ytd",8,null,s_record,null,s_order_cnt_OF_s_record,0x04400000);
            s_order_cnt_OF_s_record.declare(_memory,1680,4,"s-order-cnt",4,null,s_record,null,s_remote_cnt_OF_s_record,0x04400000);
            s_remote_cnt_OF_s_record.declare(_memory,1684,4,"s-remote-cnt",4,null,s_record,null,s_data_OF_s_record,0x04400000);
            s_data_OF_s_record.declare(_memory,1688,50,"s-data",null,null,s_record,null,null,0x00000000);
            s_record.declare(_memory,1410,328,"s-record",null,null,null,stock_key_OF_s_record,currentdate,0x00000000);
            ...
            filler_0_.declare(_memory,1752,19,"datetime",null,null,null,dtyear_OF_filler_0_,i,0x00100000,1,1,datetime);
            ...
            ws_line_item.declare(_memory,1779,4,"ws-line-item",9,null,null,null,ws_olno,0x04400000);
            ws_olno.declare(_memory,1783,4,"ws-olno",9,null,null,null,response,0x04400000);
            ...
            err_name.declare(_memory,1797,24,"err-name",null,null,null,null,err_fn,0x00000000);
            err_fn.declare(_memory,1821,24,"err-fn",null,null,null,null,tpc_trace_data_block,0x00000000);
            tpc_trace_module_id_OF_tpc_trace_data_block.declare(_memory,1929,1,"tpc-trace-module-id",null,null,tpc_trace_data_block,null,tpc_trace_call_seq_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_seq_OF_tpc_trace_data_block.declare(_memory,1930,1,"tpc-trace-call-seq",null,null,tpc_trace_data_block,null,tpc_trace_call_type_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_type_OF_tpc_trace_data_block.declare(_memory,1931,1,"tpc-trace-call-type",null,null,tpc_trace_data_block,null,tpc_trace_data_length_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_data_length_OF_tpc_trace_data_block.declare(_memory,1932,2,"tpc-trace-data-length",4,null,tpc_trace_data_block,null,tpc_trace_data_OF_tpc_trace_data_block,0x04000000);
            tpc_trace_data_OF_tpc_trace_data_block.declare(_memory,1934,128,"tpc-trace-data",null,null,tpc_trace_data_block,null,filler_6__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block.declare(_memory,1936,2,"tpc-trace-vsm-function",null,null,filler_6__OF_tpc_trace_data_block,null,tpc_trace_info_OF_filler_6__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_info_OF_filler_6__OF_tpc_trace_data_block.declare(_memory,1938,124,"tpc-trace-info",null,null,filler_6__OF_tpc_trace_data_block,null,null,0x00000000);
            filler_6__OF_tpc_trace_data_block.declare(_memory,1934,128,"tpc-trace-data",null,null,tpc_trace_data_block,tpc_trace_vsm_function_OF_filler_6__OF_tpc_trace_data_block,null,0x00100000,1,1,tpc_trace_data_OF_tpc_trace_data_block);
            tpc_trace_data_block.declare(_memory,1929,133,"tpc-trace-data-block",null,null,null,tpc_trace_module_id_OF_tpc_trace_data_block,null,0x00000000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            tpc_trace_reqd_OF_tpc_trace_flag_OF_common_data_OF_new_order_data_OF_dfhcommarea=new Level88("tpc-trace-reqd",tpc_trace_flag_OF_common_data_OF_new_order_data_OF_dfhcommarea, "Y", null, null, null, new Object[]{"Y"});
        ...
        public void declarations()
        {
            ...
            no_item_key_OF_no_item_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,74,10,"no-item-key",null,null,no_item_data_OF_new_order_data_OF_dfhcommarea,supware_OF_no_item_key_OF_no_item_data_OF_new_order_data_OF_dfhcommarea,iname_OF_no_item_data_OF_new_order_data_OF_dfhcommarea,0x00000000);
            ...
            no_item_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,72,55,"no-item-data",null,null,new_order_data_OF_dfhcommarea,olno_OF_no_item_data_OF_new_order_data_OF_dfhcommarea,total_OF_new_order_data_OF_dfhcommarea,0x00000000,1,15,null);
            ...
            result_code_OF_common_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,1065,4,"result-code",9,null,common_data_OF_new_order_data_OF_dfhcommarea,null,tpc_trace_flag_OF_common_data_OF_new_order_data_OF_dfhcommarea,0x04400000);
            tpc_trace_flag_OF_common_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,1069,1,"tpc-trace-flag",null,null,common_data_OF_new_order_data_OF_dfhcommarea,null,td_data_OF_common_data_OF_new_order_data_OF_dfhcommarea,0x00000000);
            td_data_OF_common_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,1070,120,"td-data",null,null,common_data_OF_new_order_data_OF_dfhcommarea,null,null,0x00000000);
            common_data_OF_new_order_data_OF_dfhcommarea.declare(_memory,905,285,"common-data",null,null,new_order_data_OF_dfhcommarea,err_OF_common_data_OF_new_order_data_OF_dfhcommarea,null,0x00000000);
            new_order_data_OF_dfhcommarea.declare(_memory,0,1190,"new-order-data",null,null,dfhcommarea,wid_OF_new_order_data_OF_dfhcommarea,null,0x00000000);
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 6: if( (_begin=invaliditem_OF_main()) != 0) break;
                    if(_end==_invaliditem_OF_main_Label) return  ;
                    
                    if(_end==1) { return  ; }
                    
                    case 7: case 8: if( (_begin=defaultpara_0_OF_cicserror()) != 0) break;
                    if(_end==_defaultpara_0_OF_cicserror_Label) return  ;
                    
                    case 9: h_OF_cicserror();
                    if(_end==_h_OF_cicserror_Label) return  ;
