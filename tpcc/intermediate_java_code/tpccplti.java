...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM TPCCPLTI ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void declarations()
        {
            ...
            ws_cwa_ptr.declare(_memory,8,4,"ws-cwa-ptr",null,null,null,null,ws_tpc_trace_module,0x00000000);
            ws_tpc_trace_module.declare(_memory,12,8,"ws-tpc-trace-module",null,"TPCTRACE",null,null,ws_load_resp,0x00000000);
            ws_load_resp.declare(_memory,24,4,"ws-load-resp",8,"-1",null,null,null,0x04400000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            trace_module_missing_OF_cwa_tpc_trace_module_name_OF_tpcc_cwa=new Level88("trace-module-missing",cwa_tpc_trace_module_name_OF_tpcc_cwa, "=NOTRCE=", null, null, null, new Object[]{"=NOTRCE="});
        ...
        {
            final Memory _memory=this._memory;
            cwa_eyecatcher_OF_tpcc_cwa.declare(_memory,0,4,"cwa-eyecatcher",null,null,tpcc_cwa,null,cwa_tpc_trace_module_name_OF_tpcc_cwa,0x00000000);
            cwa_tpc_trace_module_name_OF_tpcc_cwa.declare(_memory,4,8,"cwa-tpc-trace-module-name",null,null,tpcc_cwa,null,cwa_trace_options_array_OF_tpcc_cwa,0x00000000);
            ...
            cwa_trace_options_array_OF_tpcc_cwa.declare(_memory,12,12,"cwa-trace-options-array",null,null,tpcc_cwa,null,null,0x00000000);
            tpcc_cwa.declare(_memory,0,24,"tpcc-cwa",null,null,null,cwa_eyecatcher_OF_tpcc_cwa,dfheiblk,0x00000000);
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 2: case 1: if( (_begin=main_paragraph_OF_defaultsection_0()) != 0) break;
