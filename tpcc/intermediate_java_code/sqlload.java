...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM SQLLOAD ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void declarations()
        {
            ...
            l_maxitems.declare(_memory,8,4,"L-MAXITEMS",9,"100000",null,null,l_dist_per_ware,0x04000000);
            l_dist_per_ware.declare(_memory,12,4,"L-DIST-PER-WARE",9,"10",null,null,l_cust_per_dist,0x04000000);
            l_cust_per_dist.declare(_memory,16,4,"L-CUST-PER-DIST",9,"3000",null,null,l_ord_per_dist,0x04000000);
            l_ord_per_dist.declare(_memory,20,4,"L-ORD-PER-DIST",9,"3000",null,null,l_undel_ord_base,0x04000000);
            l_undel_ord_base.declare(_memory,24,4,"L-UNDEL-ORD-BASE",9,"2100",null,null,l_min_name,0x04000000);
            l_min_name.declare(_memory,28,4,"L-MIN-NAME",9,"0",null,null,l_max_name,0x04000000);
            l_max_name.declare(_memory,32,4,"L-MAX-NAME",9,"999",null,null,l_name_a,0x04000000);
            l_name_a.declare(_memory,36,4,"L-NAME-A",9,"255",null,null,l_name_c,0x04000000);
            l_name_c.declare(_memory,40,4,"L-NAME-C",9,"17",null,null,s_maxitems,0x04000000);
            s_maxitems.declare(_memory,44,4,"S-MAXITEMS",9,"1000",null,null,s_dist_per_ware,0x04000000);
            s_dist_per_ware.declare(_memory,48,4,"S-DIST-PER-WARE",9,"2",null,null,s_cust_per_dist,0x04000000);
            s_cust_per_dist.declare(_memory,52,4,"S-CUST-PER-DIST",9,"300",null,null,s_ord_per_dist,0x04000000);
            s_ord_per_dist.declare(_memory,56,4,"S-ORD-PER-DIST",9,"300",null,null,s_undel_ord_base,0x04000000);
            s_undel_ord_base.declare(_memory,60,4,"S-UNDEL-ORD-BASE",9,"210",null,null,s_min_name,0x04000000);
            s_min_name.declare(_memory,64,4,"S-MIN-NAME",9,"0",null,null,s_max_name,0x04000000);
            s_max_name.declare(_memory,68,4,"S-MAX-NAME",9,"99",null,null,s_name_a,0x04000000);
            s_name_a.declare(_memory,72,4,"S-NAME-A",9,"23",null,null,s_name_c,0x04000000);
            s_name_c.declare(_memory,76,4,"S-NAME-C",9,"3",null,null,maxitems,0x04000000);
            maxitems.declare(_memory,80,4,"MAXITEMS",9,null,null,null,dist_per_ware,0x04000000);
            dist_per_ware.declare(_memory,84,4,"DIST-PER-WARE",9,null,null,null,cust_per_dist,0x04000000);
            cust_per_dist.declare(_memory,88,4,"CUST-PER-DIST",9,null,null,null,ord_per_dist,0x04000000);
            ord_per_dist.declare(_memory,92,4,"ORD-PER-DIST",9,null,null,null,undel_ord_base,0x04000000);
            undel_ord_base.declare(_memory,96,4,"UNDEL-ORD-BASE",9,null,null,null,name_min,0x04000000);
            name_min.declare(_memory,100,4,"name-min",9,null,null,null,name_max,0x04000000);
            name_max.declare(_memory,104,4,"name-max",9,null,null,null,name_a,0x04000000);
            name_a.declare(_memory,108,4,"name-a",9,null,null,null,name_c,0x04000000);
            name_c.declare(_memory,112,4,"name-c",9,null,null,null,ws_time_start,0x04000000);
            ws_time_start.declare(_memory,116,8,"ws-time-start",8,null,null,null,ws_time_end,0x04000000);
            ws_time_end.declare(_memory,124,8,"ws-time-end",8,null,null,null,ws_timer_msg,0x04000000);
            ws_timer_start_OF_ws_timer_msg.declare(_memory,140,20,"ws-timer-start",null,"Started at: hh:mm:ss",ws_timer_msg,null,ws_timer_end_OF_ws_timer_msg,0x00000000);
            _Variable.reset().declare(_memory,160,2,null,null,", ",ws_timer_msg,null,null,0x00000000).notifyParent();
            ws_timer_end_OF_ws_timer_msg.declare(_memory,162,18,"ws-timer-end",null,"Ended at: hh:mm:ss",ws_timer_msg,null,null,0x00000000);
            ws_timer_msg.declare(_memory,140,40,"ws-timer-msg",null,null,null,ws_timer_start_OF_ws_timer_msg,sqlstate,0x00000000);
            ...
            count_ware.declare(_memory,536,4,"count-ware",9,null,null,null,w_id,0x04400000);
            w_id.declare(_memory,540,4,"w-id",9,null,null,null,w_name,0x04400000);
            w_name.declare(_memory,544,10,"w-name",null,null,null,null,w_street_1,0x00000000);
            w_street_1.declare(_memory,554,20,"w-street-1",null,null,null,null,w_street_2,0x00000000);
            w_street_2.declare(_memory,574,20,"w-street-2",null,null,null,null,w_city,0x00000000);
            w_city.declare(_memory,594,20,"w-city",null,null,null,null,w_state,0x00000000);
            w_state.declare(_memory,614,2,"w-state",null,null,null,null,w_zip,0x00000000);
            w_zip.declare(_memory,616,9,"w-zip",null,null,null,null,w_tax,0x00000000);
            w_tax.declare(_memory,625,3,"w-tax",4,null,null,null,w_ytd,0x04400000,4,0);
            w_ytd.declare(_memory,628,7,"w-ytd",12,null,null,null,i_id,0x04400000,2,0);
            i_id.declare(_memory,635,4,"i-id",9,null,null,null,i_name,0x04400000);
            i_name.declare(_memory,643,24,"i-name",null,null,null,null,i_price,0x00000000);
            i_price.declare(_memory,667,3,"i-price",5,null,null,null,i_data,0x04400000,2,0);
            i_data.declare(_memory,670,50,"i-data",null,null,null,null,s_i_id,0x00000000);
            s_i_id.declare(_memory,720,4,"s-i-id",9,null,null,null,s_w_id,0x04400000);
            s_w_id.declare(_memory,724,4,"s-w-id",9,null,null,null,s_quantity,0x04400000);
            s_quantity.declare(_memory,728,3,"s-quantity",4,null,null,null,s_dist_01,0x04400000);
            s_dist_01.declare(_memory,731,24,"s-dist-01",null,null,null,null,s_dist_02,0x00000000);
            s_dist_02.declare(_memory,755,24,"s-dist-02",null,null,null,null,s_dist_03,0x00000000);
            s_dist_03.declare(_memory,779,24,"s-dist-03",null,null,null,null,s_dist_04,0x00000000);
            s_dist_04.declare(_memory,803,24,"s-dist-04",null,null,null,null,s_dist_05,0x00000000);
            s_dist_05.declare(_memory,827,24,"s-dist-05",null,null,null,null,s_dist_06,0x00000000);
            s_dist_06.declare(_memory,851,24,"s-dist-06",null,null,null,null,s_dist_07,0x00000000);
            s_dist_07.declare(_memory,875,24,"s-dist-07",null,null,null,null,s_dist_08,0x00000000);
            s_dist_08.declare(_memory,899,24,"s-dist-08",null,null,null,null,s_dist_09,0x00000000);
            s_dist_09.declare(_memory,923,24,"s-dist-09",null,null,null,null,s_dist_10,0x00000000);
            s_dist_10.declare(_memory,947,24,"s-dist-10",null,null,null,null,s_data,0x00000000);
            s_data.declare(_memory,971,50,"s-data",null,null,null,null,o_id,0x00000000);
            o_id.declare(_memory,1021,4,"o-id",9,null,null,null,o_d_id,0x04400000);
            o_d_id.declare(_memory,1025,4,"o-d-id",9,null,null,null,o_w_id,0x04400000);
            o_w_id.declare(_memory,1029,4,"o-w-id",9,null,null,null,o_c_id,0x04400000);
            o_c_id.declare(_memory,1033,4,"o-c-id",9,null,null,null,o_carrier_id,0x04400000);
            o_carrier_id.declare(_memory,1037,4,"o-carrier-id",9,null,null,null,o_ol_cnt,0x04400000);
            o_ol_cnt.declare(_memory,1041,4,"o-ol-cnt",9,null,null,null,ol_number,0x04400000);
            ol_number.declare(_memory,1061,4,"ol-number",9,null,null,null,ol_i_id,0x04400000);
            ol_i_id.declare(_memory,1065,4,"ol-i-id",9,null,null,null,ol_supply_w_id,0x04400000);
            ol_supply_w_id.declare(_memory,1069,4,"ol-supply-w-id",9,null,null,null,ol_quantity,0x04400000);
            ol_quantity.declare(_memory,1073,4,"ol-quantity",9,null,null,null,ol_amount,0x04400000);
            ol_amount.declare(_memory,1077,4,"ol-amount",9,null,null,null,ol_dist_info,0x04400000);
            ol_dist_info.declare(_memory,1081,24,"ol-dist-info",null,null,null,null,d_id,0x00000000);
            d_id.declare(_memory,1112,4,"d-id",9,null,null,null,d_w_id,0x04400000);
            d_w_id.declare(_memory,1116,4,"d-w-id",9,null,null,null,d_name,0x04400000);
            d_name.declare(_memory,1120,10,"d-name",null,null,null,null,d_street_1,0x00000000);
            d_street_1.declare(_memory,1130,20,"d-street-1",null,null,null,null,d_street_2,0x00000000);
            d_street_2.declare(_memory,1150,20,"d-street-2",null,null,null,null,d_city,0x00000000);
            d_city.declare(_memory,1170,20,"d-city",null,null,null,null,d_state,0x00000000);
            d_state.declare(_memory,1190,2,"d-state",null,null,null,null,d_zip,0x00000000);
            d_zip.declare(_memory,1192,9,"d-zip",null,null,null,null,d_tax,0x00000000);
            d_tax.declare(_memory,1201,3,"d-tax",4,null,null,null,d_ytd,0x04400000,4,0);
            d_ytd.declare(_memory,1204,7,"d-ytd",12,null,null,null,d_next_o_id,0x04400000,2,0);
            d_next_o_id.declare(_memory,1211,4,"d-next-o-id",9,null,null,null,c_id,0x04400000);
            c_id.declare(_memory,1215,4,"c-id",9,null,null,null,c_d_id,0x04400000);
            c_d_id.declare(_memory,1219,4,"c-d-id",9,null,null,null,c_w_id,0x04400000);
            c_w_id.declare(_memory,1223,4,"c-w-id",9,null,null,null,c_first,0x04400000);
            c_first.declare(_memory,1227,16,"c-first",null,null,null,null,c_middle,0x00000000);
            c_middle.declare(_memory,1243,2,"c-middle",null,null,null,null,c_last,0x00000000);
            c_last.declare(_memory,1245,16,"c-last",null,null,null,null,c_street_1,0x00000000);
            c_street_1.declare(_memory,1261,20,"c-street-1",null,null,null,null,c_street_2,0x00000000);
            c_street_2.declare(_memory,1281,20,"c-street-2",null,null,null,null,c_city,0x00000000);
            c_city.declare(_memory,1301,20,"c-city",null,null,null,null,c_state,0x00000000);
            c_state.declare(_memory,1321,2,"c-state",null,null,null,null,c_zip,0x00000000);
            c_zip.declare(_memory,1323,9,"c-zip",null,null,null,null,c_phone,0x00000000);
            c_phone.declare(_memory,1332,16,"c-phone",null,null,null,null,c_credit,0x00000000);
            c_credit.declare(_memory,1368,2,"c-credit",null,null,null,null,c_credit_lim,0x00000000);
            c_credit_lim.declare(_memory,1370,7,"c-credit-lim",12,null,null,null,c_discount,0x04400000,2,0);
            c_discount.declare(_memory,1377,3,"c-discount",4,null,null,null,c_balance,0x04400000,4,0);
            c_balance.declare(_memory,1380,7,"c-balance",12,null,null,null,c_data,0x04400000,2,0);
            c_data_len_OF_c_data.declare(_memory,1398,2,"c-data-len",4,null,c_data,null,c_data_data_OF_c_data,0x04400000);
            c_data_data_OF_c_data.declare(_memory,1400,500,"c-data-data",null,null,c_data,null,null,0x00000000);
            c_data.declare(_memory,1398,502,"c-data",null,null,null,c_data_len_OF_c_data,h_amount,0x00002000);
            h_amount.declare(_memory,2402,4,"h-amount",6,null,null,null,h_data,0x04400000,2,0);
            h_data.declare(_memory,2406,24,"h-data",null,null,null,null,csqlcode,0x00000000);
            csqlcode.declare(_memory,2522,10,"CSQLCODE","+999999999","+999999999",null,null,null,ws_display,0x0c200000);
            ws_row_OF_ws_display.declare(_memory,2532,2,"ws-row",4,"0",ws_display,null,ws_col_OF_ws_display,0x04000000);
            ws_col_OF_ws_display.declare(_memory,2534,2,"ws-col",4,"0",ws_display,null,ws_cpos_OF_ws_display,0x04000000);
            ws_cpos_OF_ws_display.declare(_memory,2536,2,"ws-cpos",4,null,ws_display,null,ws_num_OF_ws_display,0x04000000);
            ws_num_OF_ws_display.declare(_memory,2538,10,"ws-num","+999999999","+999999999",null,ws_display,null,ws_display_line_OF_ws_display,0x0c200000);
            ws_display_line_OF_ws_display.declare(_memory,2548,79,"ws-display-line",null,null,ws_display,null,ws_d_tax_OF_ws_display,0x00000000);
            ws_d_tax_OF_ws_display.declare(_memory,2627,6,"ws-d-tax","-.9999","-.9999",null,ws_display,null,ws_w_tax_OF_ws_display,0x0c200000,4,0);
            ws_w_tax_OF_ws_display.declare(_memory,2633,6,"ws-w-tax","-.9999","-.9999",null,ws_display,null,ws_i_price_OF_ws_display,0x0c200000,4,0);
            ws_i_price_OF_ws_display.declare(_memory,2639,7,"ws-i-price","-999.99","-999.99",null,ws_display,null,ws_ol_amount_OF_ws_display,0x0c200000,2,0);
            ws_ol_amount_OF_ws_display.declare(_memory,2646,9,"ws-ol-amount","-99999.99","-99999.99",null,ws_display,null,ws_display_nbr_OF_ws_display,0x0c200000,2,0);
            ws_display_nbr_OF_ws_display.declare(_memory,2655,7,"ws-display-nbr","ZZZZZ9-","ZZZZZ9-",null,ws_display,null,ws_display_nb2_OF_ws_display,0x0c400000);
            ws_display_nb2_OF_ws_display.declare(_memory,2662,7,"ws-display-nb2","ZZZZZ9-","ZZZZZ9-",null,ws_display,null,ws_display_nb3_OF_ws_display,0x0c400000);
            ws_display_nb3_OF_ws_display.declare(_memory,2669,7,"ws-display-nb3","ZZZZZ9-","ZZZZZ9-",null,ws_display,null,ws_display_nb4_OF_ws_display,0x0c400000);
            ws_display_nb4_OF_ws_display.declare(_memory,2676,7,"ws-display-nb4","ZZZZZ9-","ZZZZZ9-",null,ws_display,null,null,0x0c400000);
            ws_display.declare(_memory,2532,151,"ws-display",null,null,null,ws_row_OF_ws_display,i,0x00000000);
            ...
            time_in_secs_OF_current_tstamp.declare(_memory,2696,8,"time-in-secs",8,null,current_tstamp,null,null,0x04000000);
            current_tstamp.declare(_memory,2687,17,"current-tstamp",null,null,null,todaysdate_OF_current_tstamp,a,0x00000000);
            ...
            rand_min.declare(_memory,2720,4,"rand-min",9,null,null,null,rand_min1,0x04400000);
            rand_min1.declare(_memory,2724,4,"rand-min1",9,null,null,null,rand_max,0x04400000);
            rand_max.declare(_memory,2728,4,"rand-max",9,null,null,null,rand_max1,0x04400000);
            rand_max1.declare(_memory,2732,4,"rand-max1",9,null,null,null,rand_num,0x04400000);
            rand_num.declare(_memory,2736,4,"rand-num",9,null,null,null,rand_num1,0x04400000);
            rand_num1.declare(_memory,2740,4,"rand-num1",9,null,null,null,temp,0x04400000);
            ...
            name_num.declare(_memory,2760,4,"name-num",9,null,null,null,name_res,0x04400000);
            name_res.declare(_memory,2764,15,"name-res",null,null,null,null,chars,0x00000000);
            ...
            str_min.declare(_memory,2851,4,"str-min",9,null,null,null,str_max,0x04400000);
            str_max.declare(_memory,2855,4,"str-max",9,null,null,null,str_ind,0x04400000);
            str_ind.declare(_memory,2859,4,"str-ind",9,null,null,null,str_len,0x04400000);
            str_len.declare(_memory,2863,4,"str-len",9,null,null,null,str_val,0x04400000);
            str_val.declare(_memory,2867,500,"str-val",null,null,null,null,adr_str1,0x00000000);
            adr_str1.declare(_memory,3367,20,"adr-str1",null,null,null,null,adr_str2,0x00000000);
            adr_str2.declare(_memory,3387,20,"adr-str2",null,null,null,null,adr_city,0x00000000);
            adr_city.declare(_memory,3407,20,"adr-city",null,null,null,null,adr_state,0x00000000);
            adr_state.declare(_memory,3427,2,"adr-state",null,null,null,null,adr_zip,0x00000000);
            adr_zip.declare(_memory,3429,9,"adr-zip",null,null,null,null,filler_2_,0x00000000);
            ...
            filler_2_.declare(_memory,3438,50,"filler",null,null,null,nn_OF_filler_2_,cust_temp,0x00000000);
            cust_temp.declare(_memory,3488,4,"cust-temp",9,null,null,null,filler_d_,0x04400000);
            cust_perm_OF_filler_d_.declare(_memory,3492,4,"cust-perm",9,null,filler_d_,null,null,0x04400000,1,3000,null);
            filler_d_.declare(_memory,3492,12000,"filler",null,null,null,cust_perm_OF_filler_d_,sdatasiz,0x00000000);
            ...
            filler_e_.declare(_memory,15500,400000,"filler",null,null,null,orig_OF_filler_e_,posn,0x00000000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void declarations()
        {
            ...
            option_display_OF_option_array_OF_dfhcommarea.declare(_memory,28,4,"option-display",9,null,option_array_OF_dfhcommarea,null,null,0x04400000);
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 14: case 15: randomnumber_para_OF_randomnumber();
                    if(_end==_randomnumber_para_OF_randomnumber_Label) return  ;
                    
                    if(_end==14) { return  ; }
                    
                    case 16: case 17: nurand_para_OF_nurand();
                    if(_end==_nurand_para_OF_nurand_Label) return  ;
                    
                    if(_end==16) { return  ; }
                    
                    case 18: case 19: makealphastring_para_OF_makealphastring();
                    if(_end==_makealphastring_para_OF_makealphastring_Label) return  ;
                    
                    if(_end==18) { return  ; }
                    
                    case 20: case 21: makenumberstring_para_OF_makenumberstring();
                    if(_end==_makenumberstring_para_OF_makenumberstring_Label) return  ;
                    
                    if(_end==20) { return  ; }
                    
                    case 23: case 24: if( (_begin=loaditems_para_OF_loaditems()) != 0) break;
                    if(_end==_loaditems_para_OF_loaditems_Label) return  ;
                    
                    if(_end==23) { return  ; }
                    
                    case 31: case 32: if( (_begin=loadware_para_OF_loadware()) != 0) break;
                    if(_end==_loadware_para_OF_loadware_Label) return  ;
                    
                    if(_end==31) { return  ; }
                    
                    case 41: case 42: if( (_begin=loadcust_para_OF_loadcust()) != 0) break;
                    if(_end==_loadcust_para_OF_loadcust_Label) return  ;
                    
                    if(_end==41) { return  ; }
                    
                    case 47: case 48: if( (_begin=loadord_para_OF_loadord()) != 0) break;
                    ...
                    case 85: case 86: if( (_begin=sqlerror_para_OF_sqlerror()) != 0) break;
                    if(_end==_sqlerror_para_OF_sqlerror_Label) return  ;
                    
                    if(_end==85) { return  ; }
                    
                    case 88: case 89: if( (_begin=display_line_para_OF_display_line()) != 0) break;
                    if(_end==_display_line_para_OF_display_line_Label) return  ;
                    
                    if(_end==88) { return  ; }
                    
                    case 91: case 92: if( (_begin=display_dot_para_OF_display_dot()) != 0) break;
                    if(_end==_display_dot_para_OF_display_dot_Label) return  ;
                    
                    if(_end==91) { return  ; }
                    
                    case 94: case 95: if( (_begin=display_number_para_OF_display_number()) != 0) break;
    ...
    public int _sqlWarningHandler(java.sql.SQLWarning _sqlException,int _notFoundLabel,int _warningLabel,int _errorLabel)
    {
        ...
        String _sqlResult;
        if (_errorCode==0){_errorCode=-1;_sqlResult="01";}
        else {_sqlResult=SqlContext.obtainSqlState(_sqlException);}
