...
implements ICobolProgram, com.heirloomcomputing.ecs.api.ICallTarget, com.heirloomcomputing.ecs.api.ICancelTarget , com.heirloomcomputing.etp.transaction.link.Linkable
{
    ...
    {
        return "PROGRAM VSMPAYM ("+super.toString()+"):"+String.valueOf(_context);
    }
    ...
    public class Wrk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            trace_vsmpaym_OF_tpc_trace_module_id_OF_tpc_trace_data_block=new Level88("trace-vsmpaym",tpc_trace_module_id_OF_tpc_trace_data_block, new byte[]{-35}, null, null, null, new Object[]{new byte[]{-35}});
            ...
            trace_vsm_read_next_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-read-next",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "RN", null, null, null, new Object[]{"RN"});
            trace_vsm_read_update_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-read-update",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "RU", null, null, null, new Object[]{"RU"});
            trace_vsm_write_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-write",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "W ", null, null, null, new Object[]{"W "});
            trace_vsm_rewrite_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-rewrite",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "RW", null, null, null, new Object[]{"RW"});
            trace_vsm_start_br_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-start-br",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "SB", null, null, null, new Object[]{"SB"});
            trace_vsm_stop_br_OF_tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block=new Level88("trace-vsm-stop-br",tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block, "ZB", null, null, null, new Object[]{"ZB"});
        ...
        public void declarations()
        {
            ...
            c_payment_cnt_OF_c_record.declare(_memory,466,4,"c-payment-cnt",4,null,c_record,null,c_data_OF_c_record,0x04000000);
            c_data_OF_c_record.declare(_memory,474,500,"c-data",null,null,c_record,null,null,0x00000000);
            c_record.declare(_memory,238,736,"c-record",null,null,null,customer_key_OF_c_record,h_record,0x00000000);
            h_c_w_id_OF_history_key_OF_h_record.declare(_memory,974,9,"h-c-w-id",9,null,history_key_OF_h_record,null,h_c_d_id_OF_history_key_OF_h_record,0x04400000);
            h_c_d_id_OF_history_key_OF_h_record.declare(_memory,983,9,"h-c-d-id",9,null,history_key_OF_h_record,null,h_c_id_OF_history_key_OF_h_record,0x04400000);
            h_c_id_OF_history_key_OF_h_record.declare(_memory,992,9,"h-c-id",9,null,history_key_OF_h_record,null,h_date_OF_history_key_OF_h_record,0x04400000);
            h_date_OF_history_key_OF_h_record.declare(_memory,1001,20,"h-date",null,null,history_key_OF_h_record,null,h_d_id_OF_history_key_OF_h_record,0x00000000);
            h_d_id_OF_history_key_OF_h_record.declare(_memory,1021,9,"h-d-id",9,null,history_key_OF_h_record,null,h_w_id_OF_history_key_OF_h_record,0x04400000);
            h_w_id_OF_history_key_OF_h_record.declare(_memory,1030,9,"h-w-id",9,null,history_key_OF_h_record,null,h_amount_OF_history_key_OF_h_record,0x04400000);
            h_amount_OF_history_key_OF_h_record.declare(_memory,1039,6,"h-amount",6,null,history_key_OF_h_record,null,h_data_OF_history_key_OF_h_record,0x04400000,2,0);
            h_data_OF_history_key_OF_h_record.declare(_memory,1045,24,"h-data",null,null,history_key_OF_h_record,null,null,0x00000000);
            history_key_OF_h_record.declare(_memory,974,95,"history-key",null,null,h_record,h_c_w_id_OF_history_key_OF_h_record,null,0x00000000);
            h_record.declare(_memory,974,95,"h-record",null,null,null,history_key_OF_h_record,currentdate,0x00000000);
            ...
            filler_0_.declare(_memory,1752,19,"datetime",null,null,null,dtyear_OF_filler_0_,namecnt,0x00100000,1,1,datetime);
            namecnt.declare(_memory,1779,4,"namecnt",9,null,null,null,c_new_data,0x04400000);
            c_new_data.declare(_memory,1783,500,"c-new-data",null,null,null,null,cust_tab_ind,0x00000000);
            cust_tab_ind.declare(_memory,2283,9,"cust-tab-ind",9,null,null,null,filler_6_,0x04400000);
            t_c_id_OF_cust_tab_OF_filler_6_.declare(_memory,2292,4,"t-c-id",9,null,cust_tab_OF_filler_6_,null,t_c_d_id_OF_cust_tab_OF_filler_6_,0x04400000);
            t_c_d_id_OF_cust_tab_OF_filler_6_.declare(_memory,2296,4,"t-c-d-id",9,null,cust_tab_OF_filler_6_,null,t_c_w_id_OF_cust_tab_OF_filler_6_,0x04400000);
            t_c_w_id_OF_cust_tab_OF_filler_6_.declare(_memory,2300,4,"t-c-w-id",9,null,cust_tab_OF_filler_6_,null,t_c_first_OF_cust_tab_OF_filler_6_,0x04400000);
            t_c_first_OF_cust_tab_OF_filler_6_.declare(_memory,2304,16,"t-c-first",null,null,cust_tab_OF_filler_6_,null,null,0x00000000);
            cust_tab_OF_filler_6_.declare(_memory,2292,28,"cust-tab",null,null,filler_6_,t_c_id_OF_cust_tab_OF_filler_6_,null,0x00000000,0,30000,cust_tab_ind);
            filler_6_.declare(_memory,2292,840000,"filler",null,null,null,cust_tab_OF_filler_6_,response,0x00000000);
            ...
            err_name.declare(_memory,842302,24,"err-name",null,null,null,null,err_fn,0x00000000);
            err_fn.declare(_memory,842326,24,"err-fn",null,null,null,null,tpc_trace_data_block,0x00000000);
            tpc_trace_module_id_OF_tpc_trace_data_block.declare(_memory,842434,1,"tpc-trace-module-id",null,null,tpc_trace_data_block,null,tpc_trace_call_seq_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_seq_OF_tpc_trace_data_block.declare(_memory,842435,1,"tpc-trace-call-seq",null,null,tpc_trace_data_block,null,tpc_trace_call_type_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_call_type_OF_tpc_trace_data_block.declare(_memory,842436,1,"tpc-trace-call-type",null,null,tpc_trace_data_block,null,tpc_trace_data_length_OF_tpc_trace_data_block,0x00000000);
            tpc_trace_data_length_OF_tpc_trace_data_block.declare(_memory,842437,2,"tpc-trace-data-length",4,null,tpc_trace_data_block,null,tpc_trace_data_OF_tpc_trace_data_block,0x04000000);
            tpc_trace_data_OF_tpc_trace_data_block.declare(_memory,842439,128,"tpc-trace-data",null,null,tpc_trace_data_block,null,filler_7__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block.declare(_memory,842441,2,"tpc-trace-vsm-function",null,null,filler_7__OF_tpc_trace_data_block,null,tpc_trace_info_OF_filler_7__OF_tpc_trace_data_block,0x00000000);
            tpc_trace_info_OF_filler_7__OF_tpc_trace_data_block.declare(_memory,842443,124,"tpc-trace-info",null,null,filler_7__OF_tpc_trace_data_block,null,null,0x00000000);
            filler_7__OF_tpc_trace_data_block.declare(_memory,842439,128,"tpc-trace-data",null,null,tpc_trace_data_block,tpc_trace_vsm_function_OF_filler_7__OF_tpc_trace_data_block,null,0x00100000,1,1,tpc_trace_data_OF_tpc_trace_data_block);
            tpc_trace_data_block.declare(_memory,842434,133,"tpc-trace-data-block",null,null,null,tpc_trace_module_id_OF_tpc_trace_data_block,null,0x00000000);
    ...
    public class Lnk              implements Section
    {
        ...
        public void doInitializations()
        {
            ...
            tpc_trace_reqd_OF_tpc_trace_flag_OF_common_data_OF_payment_data_OF_dfhcommarea=new Level88("tpc-trace-reqd",tpc_trace_flag_OF_common_data_OF_payment_data_OF_dfhcommarea, "Y", null, null, null, new Object[]{"Y"});
        ...
        public void declarations()
        {
            ...
            result_code_OF_common_data_OF_payment_data_OF_dfhcommarea.declare(_memory,712,4,"result-code",9,null,common_data_OF_payment_data_OF_dfhcommarea,null,tpc_trace_flag_OF_common_data_OF_payment_data_OF_dfhcommarea,0x04400000);
            tpc_trace_flag_OF_common_data_OF_payment_data_OF_dfhcommarea.declare(_memory,716,1,"tpc-trace-flag",null,null,common_data_OF_payment_data_OF_dfhcommarea,null,td_data_OF_common_data_OF_payment_data_OF_dfhcommarea,0x00000000);
            td_data_OF_common_data_OF_payment_data_OF_dfhcommarea.declare(_memory,717,120,"td-data",null,null,common_data_OF_payment_data_OF_dfhcommarea,null,null,0x00000000);
            common_data_OF_payment_data_OF_dfhcommarea.declare(_memory,552,285,"common-data",null,null,payment_data_OF_dfhcommarea,err_OF_common_data_OF_payment_data_OF_dfhcommarea,null,0x00000000);
            payment_data_OF_dfhcommarea.declare(_memory,0,837,"payment-data",null,null,dfhcommarea,hdate_OF_payment_data_OF_dfhcommarea,null,0x00000000);
        ...
        try
        {
            for(;;) // forever until stopped
            {
                switch(_begin)
                {
                    ...
                    case 6: if( (_begin=cust_not_found_OF_main()) != 0) break;
                    if(_end==_cust_not_found_OF_main_Label) return  ;
