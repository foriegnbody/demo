...
--      *****************************************************************/
-- SQLFire version
-- When used with SQLFire must specify a persistent disk store
-- on each create table.  create that diskstore.
--
--create diskstore tpcc ('/var/lib/sqlfire/tpcc-diskstore');
---------------------------------------------
